...
// ⭐ YOUR EVENT ARRAY (REPLACING MOVIES)
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="px-4 py-3">
                ...
                {/* ⭐ Replaced certificate/genre with event details */}
                <p className="text-[13px] text-zinc-500 mt-1">{item.dateTime}</p>
                <p className="text-[13px] text-zinc-500">{item.location}</p>
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-6xl items-center justify-between gap-10 px-4">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="mt-3 text-[18px] text-zinc-700">{item.dateTime}</p>
              <p className="text-[16px] text-zinc-600 mt-1">{item.location}</p>
              <p className="text-[18px] font-semibold text-zinc-900 mt-3">{item.price}</p>
