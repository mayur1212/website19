...
export default function EventHero() {
  ...
  return (
    <section className="relative hidden lg:block w-full h-[520px] overflow-hidden rounded-b-[40px]">
...
>
  <ChevronRight className="w-7 h-7 text-black" />
      ...
      <div className="relative z-10 mx-auto w-[90%] h-full flex items-center justify-between px-14">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <button className="mt-5 rounded-full bg-black px-10 py-3 text-white shadow-lg hover:bg-zinc-900">
              Book tickets
            </button>
          </motion.div>
        </AnimatePresence>
      ...
      {/* ⭐ DISTRICT-STYLE LONG DOT PROGRESS BAR */}
