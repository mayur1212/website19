...
millions worldwide, shaping the sound of Indian music on a global stage.`,
  ...
  2: {
    ...
    image: "/movies/a2.jpg",
    bio: `Sunidhi Chauhan is one of India's most dynamic and versatile playback singers...`,
    events: [
      {
        id: 2,
  ...
  4: {
    ...
    image: "/movies/a4.jpg",
    bio: `Dr. Satinder Sartaaj is an internationally acclaimed Punjabi singer...`,
    events: [
      {
        id: 101,
  ...
  5: {
    name: "Jubin Nautiyal",
    image: "/movies/a5.jpg",
    bio: "Jubin Nautiyal is one of India's leading playback singers.",
    events: [],
  },
  ...
  6: {
    name: "Aditya Rikhari",
    image: "/movies/a6.jpg",
    bio: "Aditya Rikhari is a rising indie-pop performer.",
    events: [],
  },
  ...
  7: {
    name: "Badshah",
    image: "/movies/a7.jpg",
    bio: "Badshah is a leading Indian rapper.",
    events: [],
  },
  ...
  8: {
    name: "Diljit Dosanjh",
    image: "/movies/a8.jpg",
    bio: "Diljit Dosanjh is a Punjabi singer and actor.",
    events: [],
  },
};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="md:hidden">
        <SlimHeader title={artist.name} subtitle="Artist" />
      </div>
      ...
      {/* ========================== HERO ========================== */}
      <section className="px-6 lg:px-20 py-10 w-full max-w-screen-xl mx-auto flex flex-col lg:flex-row gap-10">
